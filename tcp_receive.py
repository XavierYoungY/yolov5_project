...
def sub_process(cameraIP, threshold, gpu_id, user, pw): 
    ...
    if cameraIP.split('.')[-1] in bag_ip_list:
        python_path = 'video_tcp_bag.py'
    else:
        python_path = 'video_tcp.py'
        ...
        while True:
            ...
            if len(data):
                ...
                if cameraIP not in all_cams:
                    all_cams[cameraIP] = {'sp': '', 'funcControStatus': 0, 'gpu_id': 0}
